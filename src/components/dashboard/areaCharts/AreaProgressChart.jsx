     ...
     <div className="progress-bar">
       ...
       <div className="progress-bar-list">
         {progressData.map((progressData) => {
           return (
             <div className="progress-bar-item" key={progressData.id}>
               <div className="bar-item-info">
                 <p className="bar-item-info-name">{progressData.name}</p>
                 <p className="bar-item-info-value">
                   {progressData.percentValues}
                 </p>
               </div>
               <div className="bar-item-full">
                 <div
                   ...
                   style={{
                     width: `${progressData.percentValues}%`,
                   }}
                 ></div>
               </div>
             </div>
